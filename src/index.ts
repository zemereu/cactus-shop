// 1. Definim „Forma” (Interfața) unui produs. Aici strălucește TypeScript!
interface Cactus {
    id: number;
    nume: string;
    pret: number;
...
if (butonAdauga) {
    butonAdauga.addEventListener('click', () => {
        ...
        const numeNou = (document.getElementById('input-nume') as HTMLInputElement).value;
        const pretNou = Number((document.getElementById('input-pret') as HTMLInputElement).value);
        const descriereNoua = (document.getElementById('input-descriere') as HTMLInputElement).value;
        ...
        (document.getElementById('input-nume') as HTMLInputElement).value = "";
        (document.getElementById('input-pret') as HTMLInputElement).value = "";
        (document.getElementById('input-descriere') as HTMLInputElement).value = "";
    });
}