...
let categorieSelectata: string = "Toți";
let termenCautare: string = ""; // Adăugăm o variabilă care ține minte ce am scris în bara de căutare
...
if (searchBar) {
    searchBar.addEventListener('input', (event) => {
        ...
        termenCautare = (event.target as HTMLInputElement).value.toLowerCase();
